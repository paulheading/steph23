...
export function Sample({ data, active, handleSetActive, variant, openID, series }) {
  ...
  const mapTracks = (tracks) => tracks.map((track, index) => <Track key={`track${index}`} track={track} {...trackProps} />)
