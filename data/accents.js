...
const accents = [
  ...
  region('International', [area('UK', ['RP', 'Scottish', 'Irish']), area('Spanish (fluent)', ['Mexico', 'Spain', 'Latin America']), area('Western Europe', ['France', 'Italy', 'Germany']), area('Eastern Europe', ['Poland', 'Ukraine', 'Russia']), area('Other', ['Australia', 'Canada', 'Norway'])]),
]
