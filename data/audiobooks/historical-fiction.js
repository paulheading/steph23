...
let historicalFiction = {
  ...
  tracks: [
    {
      title: `3rd person`,
      cover: path(`stephanie-cannon-us-narrator-the-lost-mother-cover-art-historical-fiction-audiobook.jpg`),
    ...
    },
    {
      ...
      cover: path(`stephanie-cannon-us-audiobook-narrator-historical-fiction-flight-girls-cover-art.jpeg`),
      src: path(`stephanie-cannon-us-audiobook-narration-sample-1st-person-southern-flight-girls-historical-fiction.mp3`),
      ...extras,
    },
    {
      title: `3rd person`,
      cover: path(`stephanie-cannon-us-audiobook-historical-fiction-narrator-not-without-my-sister-cover-art.jpeg`),
