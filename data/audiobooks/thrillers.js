...
let thrillers = {
  ...
  tracks: [
    {
      title: `1st person`,
      cover: path(`stephanie-cannon-us-audiobook-narration-1st-person-riley-sager-thrillers-the-last-time-i-lied-cover-art.jpg`),
      src: path(`stephanie-cannon-us-audiobook-narration-1st-person-riley-sager-thrillers-the-last-time-i-lied-sample.mp3`),
      ...extras,
    },
    {
      title: `3rd person`,
      cover: path(`stephanie-cannon-us-audiobook-narrator-suspense-one-night-new-york-cover-art.jpeg`),
      src: path(`stephanie-cannon-us-audiobook-narration-thriller-3rd-person-one-night-new-york-sample.mp3`),
      ...extras,
    },
    {
      title: `3rd person`,
      cover: path(`stephanie-cannon-us-audiobook-narrator-thriller-strange-things-done-cover-art.jpeg`),
