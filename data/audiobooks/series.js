  ...
  groups: [
      ...
      tracks: [
        {
          ...
          cover: path.winters(`stephanie-cannon-audiobook-narration-3rd-person-charlotte-winters-series-thriller-first-girl-gone-cover-art.jpeg`),
        ...
        },
        {
          ...
          cover: path.winters(`stephanie-cannon-audiobook-narration-3rd-person-charlotte-winters-series-thriller-girl-under-water-cover-art.jpeg`),
        ...
        },
        {
          ...
          cover: path.winters(`stephanie-cannon-audiobook-narration-3rd-person-charlotte-winters-series-thriller-watch-her-sleep-cover-art.jpeg`),
      ...
      tracks: [
        {
          ...
          cover: path.stella(`stephanie-cannon-us-audiobook-narrator-kids-fiction-angry-birds-stella-diaries-stella-has-enough-cover-art.jpeg`),
        ...
        },
        {
          ...
          cover: path.stella(`stephanie-cannon-us-audiobook-narrator-kids-fiction-angry-birds-stella-diaries-poppy-and-the-prank-too-far-cover-art.jpeg`),
        ...
        },
        {
          ...
          cover: path.stella(`stephanie-cannon-us-audiobook-narrator-kids-fiction-angry-birds-stella-diaries-willow-takes-the-stage-cover-art.jpeg`),
        ...
        },
        {
          ...
          cover: path.stella(`stephanie-cannon-us-audiobook-narrator-kids-fiction-angry-birds-stella-diaries-dahlia-and-the-ultimate-invention-cover-art.jpeg`),
        ...
        },
        {
          ...
          cover: path.stella(`stephanie-cannon-us-audiobook-narrator-childrens-fiction-lucas-lost-voice-cover-art.jpeg`),
    ...
    },
    {
      ...
      tracks: [
        {
          title: `Final Girls`,
          cover: path.saga(`stephanie-cannon-us-audiobook-narration-1st-person-riley-sager-thrillers-final-girls-cover-art.jpg`),
        ...
        },
        {
          ...
          cover: path.saga(`stephanie-cannon-audiobook-narrator-1st-person-thriller-riley-sager-the-house-across-the-lake-cover-art.jpg`),
          src: path.saga(`stephanie-cannon-audiobook-narrator-thriller-riley-sager-the-house-across-the-lake-sample.mp3`),
          ...extras,
        },
        {
          title: `Lock Every Door`,
          cover: path.saga(`stephanie-cannon-us-audiobook-narration-1st-person-riley-sager-thrillers-lock-every-door-cover-art.jpg`),
        ...
        },
        {
          ...
          cover: path.saga(`stephanie-cannon-us-audiobook-narration-1st-person-riley-sager-thrillers-the-last-time-i-lied-cover-art.jpg`),
      ...
      tracks: [
        {
          ...
          cover: path.margaret(`stephanie-cannon-audiobook-us-narrator-3rd-person-historical-fiction-marion-kummerow-a-light-in-the-window-cover-art.jpeg`),
        ...
        },
        {
          ...
          cover: path.margaret(`stephanie-cannon-audiobook-us-narrator-historical-fiction-marion-kummerow-from-the-dark-we-rise-cover-art.jpg`),
        ...
        },
        {
          ...
          cover: path.margaret(`stephanie-cannon-audiobook-us-narrator-marion-kummerow-the-girl-in-the-shadows-cover-art.jpg`),
